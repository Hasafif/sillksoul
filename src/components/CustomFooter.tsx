    ...
    <div className="wrapper">
                ...
                <div className="newsletter">     
                    ...
                    <label className="form-el">
                        ...
                        <span className={`${isRTL?'form-el--validate--arabic':'form-el--validate'} form-el--description`}>
                            {t('newsletterText')} <a href="/pages/privacy-policy" className="link">{t('privacyPolicy')}</a>.</span>
        ...
        <div className="footer__main">
			...
			<div className={`${isRTL ? 'footer-menu__title__arabic':'footer-menu__title'} accordion__trigger`}>
				...
				<ul className="footer-menu__linklist accordion__content">
						...
						<li><a href="/pages/faq">{t('faq')}</a></li>
					
						<li><a href="/pages/contact-us">{t('contactUs')}</a></li>
					
						<li><a href="/pages/exchanges-and-returns">{t('ExchangesandReturns')}</a></li>
					
						<li><a href="/pages/shipping-policy">{t('shippingPolicy')}</a></li>
					
						<li><a href="/account/">{t('Myaccount')}</a></li>
			...
			<div className="footer-menu__column accordion__item">
				...
				<ul className="footer-menu__linklist accordion__content">
						...
						<li><a href="/pages/careers">{t('Careers')}</a></li>
					
						<li><a href="/pages/terms-of-service">{t('termsOfService')}</a></li>
		...
		<div className={`${isRTL ? 'footer-menu__title__arabic':'footer-menu__title'} accordion__trigger`}>
				...
				<ul className="footer-menu__linklist accordion__content">
						...
						<li><a href="/pages/book-an-appointment">{t('PrivateViewing')}</a></li>
					
						<li><a href="/pages/book-an-appointment">{t('OnlineAppointments')}</a></li>
...
{t('contactUs')}</div>
                    <ul className="footer-menu__linklist accordion__content">
                                ...
                                <li>
                                    ...
                                    <a href="/pages/boutique-finder">{t('VisitOurBoutiques')}</a>
                                </li>  
                                ...
                                <li>
                                    ...
                                    <a href="https://us.eliesaab.com/pages/book-an-appointment">{t('BookAnAppointment')}</a>
                                </li>  
     ...
     <img 
        ...
        <div className="footer__bottom">
            ...
            <ul className="bottom-menu">
                    ...
                    <li><a href="/pages/contact-us">{t('contact')}</a></li>
                
                    <li><a href="/pages/terms-of-service">{t('termsOfService')}</a></li>
                
                    <li><a href="/pages/privacy-policy">{t('privacyPolicy')}</a></li>
            ...
            <div className="social-icons">
                    ...
                    <a target="_blank" href="https://www.facebook.com/eliesaabworld" rel="noreferrer noopener"><svg width="11" height="20" viewBox="0 0 11 20" fill="none" xmlns="http://www.w3.org/2000/svg">         <path d="M3.125 11.5633V20H6.875V11.5633H9.67109L10.2031 8.07338H6.875V5.80962C6.875 4.8539 7.34 3.92317 8.83063 3.92317H10.3438V0.951994C10.3438 0.951994 8.97008 0.716187 7.65758 0.716187C4.91656 0.716187 3.125 2.38759 3.125 5.41347V8.07338H0.078125V11.5633H3.125Z" fill="#2D2D2D"></path>     </svg></a>

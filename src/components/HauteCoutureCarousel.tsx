...
import HauteProductCard from "./HauteProductCard";
...
const HauteCoutureProductCarousel = ({ products }: ProductCarouselProps) => {
        ...
        >
          {products.map((product) => (
            <div key={product.id} className="w-1/4 flex-shrink-0 px-2">
              <HauteProductCard  product={product} />
            </div>
          ))}
        </div>
      </div>
...
export default HauteCoutureProductCarousel;
